...
public class RestaurantHandler implements HttpHandler {
    ...
    private void handleGetRestaurantById(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            // ✅ Récupérer le restaurant depuis DataService
            ...
            // ✅ CRITIQUE : Vérifier et initialiser TOUTES les propriétés
            if (dto.getId() == null) {
                dto.setId(id); // Forcer l'ID
            }
            ...
            // ✅ Vérifier que chaque plat a des toppings (même vide)
            ...
            // ✅ FIX : Retourner 404 pour ID invalide
            sendResponse(exchange, 404, "{\"error\": \"Invalid restaurant ID format\"}");
        } catch (Exception e) {
            e.printStackTrace();
            // ✅ FIX : Retourner 404 si restaurant introuvable
