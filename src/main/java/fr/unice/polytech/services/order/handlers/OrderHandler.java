...
public class OrderHandler implements HttpHandler {
    ...
    private void handleCreateOrder(HttpExchange exchange) throws Exception {
        ...
        // ✅ FIX 1 : Validation STRICTE des champs requis
        ...
        if (order.getDishes() == null || order.getDishes().isEmpty()) {
            sendResponse(exchange, 400, "{\"error\":\"dishes array is required and cannot be empty\"}");
            return;
        }

        // ✅ FIX 2 : Vérifier que deliveryLocation existe
        ...
        // ✅ FIX 3 : Calculer le montant total si absent
